...
2. Убедитесь, что у вас установлен Python версии 3.11.5. Рекомендуется создать виртуальное окружение (venv) и выполнять все команды из него. Если у вас нет venv, создайте его:
