...
def test_get_point_info_negative_value(mock_database, mocker):
    # Arrange
    geonameid = -123
    mock_cursor = mocker.Mock()
    mock_cursor.fetchone.return_value = None
...
def test_get_point_info_large_value(mock_database, mocker):
    # Arrange
    geonameid = 3456764567898765456789098765456789098765456789
    mock_cursor = mocker.Mock()
    mock_cursor.fetchone.return_value = None
    mock_database.cursor.return_value = mock_cursor
...
def test_get_point_info_multiple_calls_same_geonameid(mock_database, mocker):
    # Arrange
    geonameid = 1
    mock_cursor = mocker.Mock()
    # Different values for each key
